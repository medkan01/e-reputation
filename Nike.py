...
def get_all_pages():
    ...
    for i in range(32):
        i = f"https://fr.trustpilot.com/review/www.nike.com?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    chemin = "D:/Lorraine/Fichiers/Nike-Review.xlsx"
    ...
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["Nike", comment, date_review, likes, datetime.today().date(), "Sportwear", "Trustpilot"]
