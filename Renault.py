...
def get_all_pages():
    ...
    for i in range(26):
        i = f"https://fr.trustpilot.com/review/www.renault.fr?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["Renault", comment, date_review, likes, datetime.today().date(), "Voiture", "Trustpilot"]

            chemin = "D:/Lorraine/Fichiers/Renault-Review.xlsx"
