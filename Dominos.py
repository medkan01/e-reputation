...
def get_all_pages():
    ...
    for i in range(14):
        i = f"https://fr.trustpilot.com/review/www.dominos.fr?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["Domino's Pizza", comment, date_review, likes, datetime.today().date(), "Fast food", "Trustpilot"]

            chemin = "D:/Lorraine/Fichiers/Dominos_Pizza-Review.xlsx"
