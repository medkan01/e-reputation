...
def get_all_pages():
    ...
    for i in range(16):
        i = f"https://fr.trustpilot.com/review/www.kfc.com?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["KFC", comment, date_review, likes, datetime.today().date(), "Fast food", "Trustpilot"]

            chemin = "D:/Lorraine/Fichiers/KFC-Review.xlsx"
