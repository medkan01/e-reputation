...
def get_all_pages():
    ...
    for i in range(21):
        i = f"https://fr.trustpilot.com/review/www.peugeot.fr?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    chemin = "D:/Lorraine/Fichiers/Peugeot-Review.xlsx"
    ...
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["Peugeot", comment, date_review, likes, datetime.today().date(), "Voiture", "Trustpilot"]
