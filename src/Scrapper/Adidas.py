...
def get_all_pages():
    ...
    for i in range(21):
        i = f"https://fr.trustpilot.com/review/adidas.fr?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    chemin = "D:/Lorraine/Fichiers/Adidas-Review.xlsx"
    ...
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["Adidas", comment, date_review, likes, datetime.today().date(), "Sportwear", "Trustpilot"]
