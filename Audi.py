...
def get_all_pages():
    ...
    for i in range(6):
        i = f"https://fr.trustpilot.com/review/audi.fr?page={page_number}"
        page_number += 1
        urls.append(i)
...
def parse_comments(url):
    for url in urls:
        ...
        # print(likes)
            ...
            data = ["Audi", comment, date_review, likes, datetime.today().date(), "Voiture", "Trustpilot"]

            chemin = "D:/Lorraine/Fichiers/Audi-Review.xlsx"
